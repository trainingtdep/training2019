...
±±ºPrograma  ³ ³Nahim Terrazas		 º Data ³  21/05/18       º±±
...
user function LCREDREP()

	cPerg   := "LINECRED"   // choose the question

	CriaSX1(cPerg)
		DEFINE user_REPORT oReport NAME LCREDREP TITLE "Linea Credito" ASKPAR EXCLUSIVE
	ACTIVATE REPORT oReport LAYOUT LCREDREP FORMAT HTML
