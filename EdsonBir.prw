...
±±ºPrograma  ³ ³Edson Gonzalo Mamani Veizaga º Data ³  15/03/19           º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDescricao ³ call Invoice Power                				  º±±
...
user function EdsonBir()

	cPerg   := "EdsonBir"   // choose the question

	CriaSX1(cPerg)
		DEFINE user_REPORT oReport NAME EdsonBir TITLE "Linea Credito" ASKPAR EXCLUSIVE
	ACTIVATE REPORT oReport LAYOUT EdsonBir FORMAT HTML
